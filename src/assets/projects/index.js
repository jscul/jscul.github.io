import owlsightLogo from './owlsight/appLogo.png';
import neaLogo from './eczemawise/appLogo.png';
import aspireLogo from './aspire/appLogo.png';
import bmsClientLogo from './bms/appLogo.png';
import selfClientLogo from './portfolio/appLogo.png';

import s from '../skills';

export default {
	eczemawise: {
		skills: [s.graphql, s.nodejs, s.postgres, s.react, s.firebase],
		title: `EczemaWise`,
	...
	owlsight: {
		skills: [s.py, s.linux, s.mongodb, s.aws, s.s3],
		title: `OwlSight (NDA)`,
		slogan: ``,
		github: null,
		live: {},
	...
	porfolio: {
		...
		github: 'https://github.com/jscul/jscul.github.io/tree/development',
		live: {},
